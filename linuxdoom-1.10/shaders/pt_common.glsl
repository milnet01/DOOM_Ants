...
// GI probe cache (build step 4c), read side: ProbesRO, TriSs and giIrradiance live in
// formulas/gi_probe.glsl, shared with the raster tier (DOOM-0440). Both the camera frame
// and the multi-bounce bake read these.
